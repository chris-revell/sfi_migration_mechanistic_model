...
!  real*4,intent(in)                     :: a,wind_zonal_current,wind_merid_current
  ...
  real*4                                :: resourcelat,resourcelon,bearing,d_latlong
  ...
  do i=1,resources_shape(1)
    do j=1,resources_shape(2)
      ...
      forcemagnitude = resources_filtered(i,j)/realdistance(resourcelat,resourcelon,currentlat,currentlon)
...
real function realdistance(lata,lona,latb,lonb)
...
real function initialbearing(lat1,lon1,lat2,lon2)
